...
const TopNav = () => {
  ...
  const handleGrouping = (e, valueBool) => {
    if(valueBool){
          ...
          <>
            <div className="dropOnClick">
              <div className="selectGroup">
                <span>Grouping</span>
                <select value={groupValue} onChange={(e) => handleGrouping(e, true)} className="selectStyle" name="group" id="group">
              ...
              <div className="selectGroup">
                <span>Ordering</span>
                <select value={orderValue} onChange={(e) => handleGrouping(e, false)} className="selectStyle" name="order" id="order">
                  <option value="priority">Priority</option>
